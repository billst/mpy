...
namespace MiniPython1.walkers
{
    class AstSemantics2 : DepthFirstAdapter
    {
        ...
        public AstSemantics2(ContainersAndCurrentObjects containersArg, bool acceptMoreThan1stmts = false)
        {
        ...
        public override void CaseAMultExpression(AMultExpression node)
        {
            ...
            if (node.GetLeft() != null)
            {
                ...
                if (!(leftType.Name == "number" || leftType.Name == "general")) throw new Exception("Numbers must in be operands of a Multiplication. Line: " + Line);
            }
            ...
            if (node.GetRight() != null)
            {
                ...
                if (!(rightType.Name == "number" || rightType.Name == "general")) throw new Exception("Numbers must in be operands of a Multiplication. Line: " + Line);
            }
        ...
        public override void CaseADivExpression(ADivExpression node)
        {
            ...
            if (node.GetLeft() != null)
            {
                ...
                if (!(leftType.Name == "number" || leftType.Name == "general")) throw new Exception("Numbers must in be operands of a division. Line: " + Line);
            }
            ...
            if (node.GetRight() != null)
            {
                node.GetRight().Apply(this);
                rightType = containers.Current_TypeAttribute;
                if (!(rightType.Name == "number" || rightType.Name == "general")) throw new Exception("Numbers must in be operands of a division. Line: " + Line);
            }
        ...
        public override void CaseAPlusExpression(APlusExpression node)
        {
            ...
            if (node.GetRight() != null)
            {
                ...
                rightType = containers.Current_TypeAttribute;
                if ((rightType.Name == "string" && leftType.Name == "number") || (rightType.Name == "number" && leftType.Name == "string")) throw new Exception("Plus operands must have the some type Line: " + Line);
            }
        ...
        public override void CaseAIfStmtStmt(AIfStmtStmt node)
        {
            ...
            if (node.GetComparison() != null)
            {
             //  node.GetComparison().Apply(this);
               ...
               AstFuncDef astF = new AstFuncDef(containers);
               node.GetComparison().Apply(astF);
            }
            ...
            if (!containers.Current_TypeAttribute.Name.Equals("boolean")) throw new Exception("Comparison must be Boolean");
            {
                ...
                if (!acceptMoreThan1stmts && temp.Length > 1) throw new Exception("This Language does not accept more than one statement in statement Line near:" + containers.line_of_terminal);
        ...
        public override void CaseAWhileStmtStmt(AWhileStmtStmt node)
        {
        ...
        public override void CaseAForStmtStmt(AForStmtStmt node)
        {
            InAForStmtStmt(node);
            if (node.GetIdentInSet() != null)
            {
                node.GetIdentInSet().Apply(this);
            }
            {
                Object[] temp = new Object[node.GetStmt().Count];
                if (!acceptMoreThan1stmts && temp.Length > 1) throw new Exception("This Language does not accept more than one statement in statement Line near:" + containers.line_of_terminal);
